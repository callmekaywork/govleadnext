...
export const Header = () => {
  return (
    <div className="fixed z-10 w-full h-20 md:h-30 flex flex-col items-center bg-pink-700">
      <div className="flex flex-row justify-center items-center text-[10px] h-[20px] bg-pink-600 w-full text-white">
